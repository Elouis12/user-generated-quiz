...
let bodyMovin = document.getElementById("bodymovin");
close.addEventListener("click", function() {
    ...
    modalDiv.style.display = "none";
        bodyMovin.classList.remove("show");
...
function runModal(){
    ...
    bodyMovin.removeAttribute("style");
    bodyMovin.classList.remove("hide");
    bodyMovin.classList.add("show");
    anim.setDirection(1);
    anim.play();
    body.classList.remove("completed");
